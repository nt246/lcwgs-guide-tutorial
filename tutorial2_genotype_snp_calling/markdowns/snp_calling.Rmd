...
You can scp the pdf file to your local machine (from your local machine: scp -i XYZ.pem userX@IP:~/day2/$BASEDIR/results/diffSnpCall.pdf .) and visualise it with
