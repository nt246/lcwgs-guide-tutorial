...
Make sure you have cloned this GitHub repository to your Linux server, and change your current working directory to the `tutorial2_genotype_snp_calling folder`. Set this path as your `BASEDIR`. For example: 
